...
curl -X PUT http://$PUBSUB_SETUP_HOST/v1/projects/project/topics/rm-internal-telephone-capture-dummy
curl -X PUT http://$PUBSUB_SETUP_HOST/v1/projects/project/subscriptions/rm-internal-telephone-capture_case-processor-dummy -H 'Content-Type: application/json' -d '{"topic": "projects/project/topics/rm-internal-telephone-capture-dummy"}'
...
curl -X PUT http://$PUBSUB_SETUP_HOST/v1/projects/project/topics/rm-internal-sms-fulfilment-dummy
curl -X PUT http://$PUBSUB_SETUP_HOST/v1/projects/project/subscriptions/rm-internal-sms-fulfilment_notify-service-it -H 'Content-Type: application/json' -d '{"topic": "projects/project/topics/rm-internal-sms-fulfilment-dummy"}'
