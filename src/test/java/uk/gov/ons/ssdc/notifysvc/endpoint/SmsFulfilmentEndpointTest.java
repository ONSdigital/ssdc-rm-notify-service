...
class SmsFulfilmentEndpointTest {
    ...
    @InjectMocks
    private SmsFulfilmentEndpoint smsFulfilmentEndpoint;
    ...
    void testSmsFulfilmentServerErrorFromNotify() throws Exception {
        ...
        String expectedErrorMsg = "500 INTERNAL_SERVER_ERROR \"Error with Gov Notify when attempting to send SMS\";"
        ...
        mockMvc
                ...
                .andExpect(result -> assertThat(result.getResolvedException().getMessage()).isEqualTo(expectedErrorMsg))
                .andExpect(handler().handlerType(SmsFulfilmentEndpoint.class));
    ...
    void testValidateSmsFulfilmentRequestTemplateNotAllowedOnSurvey() {
        ...
        assertThat(thrown.getMessage()).contains("400 BAD_REQUEST \"The template for this pack code is not allowed on this survey\"");
    }
    ...
    void testValidateSmsFulfilmentRequestNoSource() {
        ...
        // Then
        assertThat(thrown.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
        assertThat(thrown.getMessage()).isEqualTo("400 BAD_REQUEST \"Invalid request header: correlationId, channel and source are mandatory\"");
    }
    ...
    void testValidateSmsFulfilmentRequestNoCorrelationId() {
        ...
        // Then
        assertThat(thrown.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
        assertThat(thrown.getMessage()).isEqualTo("400 BAD_REQUEST \"Invalid request header: correlationId, channel and source are mandatory\"");        assertThat(thrown.getMessage()).isEqualTo("400 BAD_REQUEST \"Invalid request header: correlationId, channel and source are mandatory\"");
